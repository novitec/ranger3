...
void SelectorSnapshot::enterSelector(const GenApi::CNodePtr& selector)
{
  ...
  bool alreadySaved =
    (std::find_if(mState.begin(), mState.end(),
...
void SelectorSnapshot::leaveSelector(const GenApi::CNodePtr& selector)
{
